 ...
 * @endcode
 */
$settings['hash_salt'] = 'lsaExn6jPbb_UHN9psHfKJXbgvAjYKh2XVgqbHwaXkHgWud8RSdl5Qf8Vnulo7yZMHuuFID9IA';
...
elseif (file_exists($app_root . '/' . $site_path . '/settings.development.php')) {
  include $app_root . '/' . $site_path . '/settings.development.php';
}

// Production settings.
elseif (file_exists($app_root . '/' . $site_path . '/settings.production.php')) {
